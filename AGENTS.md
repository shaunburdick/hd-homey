...
### Current Version
**1.0.0-alpha.8** - Alpha release with comprehensive tuner management improvements including connection validation, auto-scan, and soft-delete. CI/CD fixes for tests and TypeScript.
