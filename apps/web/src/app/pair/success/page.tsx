...
/** Success content card shown after a device is authorized. */
function SuccessCard({ deviceName }: { deviceName: string }) {
    return (
        <Card>
            <div className="space-y-4">
                ...
                <div className="text-center space-y-2">
                    <p className="text-secondary">You can now close this window and return to your device.</p>
        ...
        <main className="flex items-center justify-center p-6" style={{ minHeight: '100vh' }}>
            <PageContainer maxWidth="sm">
                <div className="text-center" style={{ marginBottom: 'var(--space-8)' }}>
                    ...
                    />
                    <h1 className="mb-2" style={{ marginTop: 'var(--space-4)' }}>✓ Device Authorized</h1>
                    <p className="text-secondary text-base">Your device is ready to use</p>
                </div>
                <SuccessCard deviceName={deviceName} />
            </PageContainer>
        </main>
    );
}
