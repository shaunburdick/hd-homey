 ...
 * @returns Parsed TranscodeSettings object
 */
function parseTranscodeSettingsForm(formData: FormData): TranscodeSettings {
...
export async function updateTranscodingSettingsAction(
    ...
    try {
        const settings = parseTranscodeSettingsForm(formData);
